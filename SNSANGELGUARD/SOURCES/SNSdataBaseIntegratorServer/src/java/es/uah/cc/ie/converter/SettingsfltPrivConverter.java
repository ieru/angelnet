 ...
 * @author tote
 */
@XmlRootElement(name = "settingsfltPriv")
public class SettingsfltPrivConverter {

    private SettingsfltPriv entity;
    private URI uri;
    private int expandLevel;

    /** Creates a new instance of SettingsfltPrivConverter */
    public SettingsfltPrivConverter() {
        entity = new SettingsfltPriv();
    }
     ...
     */
    public SettingsfltPrivConverter(SettingsfltPriv entity, URI uri, int expandLevel, boolean isUriExtendable) {
        this.entity = entity;
     ...
     */
    public SettingsfltPrivConverter(SettingsfltPriv entity, URI uri, int expandLevel) {
    ...
    /**
     * Getter for frecfltPriv.
     *
     * @return value for frecfltPriv
     */
    @XmlElement
    public String getFrecfltPriv() {
        return (expandLevel > 0) ? entity.getFrecfltPriv() : null;
    }

    /**
     * Setter for frecfltPriv.
     *
     * @param value the value to set
     */
    public void setFrecfltPriv(String value) {
        entity.setFrecfltPriv(value);
    }

    /**
     * Getter for activefltPriv.
     *
     * @return value for activefltPriv
     */
    @XmlElement
    public String getActivefltPriv() {
        return (expandLevel > 0) ? entity.getActivefltPriv() : null;
    }

    /**
     * Setter for activefltPriv.
     *
     * @param value the value to set
     */
    public void setActivefltPriv(String value) {
        entity.setActivefltPriv(value);
    }
    ...
    /**
     * Returns the SettingsfltPriv entity.
     *
     * @return an entity
     */
    @XmlTransient
    public SettingsfltPriv getEntity() {
        if (entity.getUserSettingsUid() == null) {
            SettingsfltPrivConverter converter = UriResolver.getInstance().resolve(SettingsfltPrivConverter.class, uri);
            if (converter != null) {
    ...
    /**
     * Returns the resolved SettingsfltPriv entity.
     *
     * @return an resolved entity
     */
    public SettingsfltPriv resolveEntity(EntityManager em) {
