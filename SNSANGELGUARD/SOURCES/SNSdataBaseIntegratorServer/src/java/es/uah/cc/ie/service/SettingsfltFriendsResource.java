...
public class SettingsfltFriendsResource {
    @Context
    ...
    /** Creates a new instance of SettingsfltFriendsResource */
    public SettingsfltFriendsResource() {
    }
    ...
    /**
     * Get method for retrieving an instance of SettingsfltFriends identified by id in XML format.
     *
    ...
    public SettingsfltFriendsConverter get(@QueryParam("expandLevel")
                                           @DefaultValue("1")
    int expandLevel) {
        PersistenceService persistenceSvc = PersistenceService.getInstance();
        try {
            persistenceSvc.beginTx();
            return new SettingsfltFriendsConverter(getEntity(), uriInfo.getAbsolutePath(), expandLevel);
        } finally {
    ...
    /**
     * Put method for updating an instance of SettingsfltFriends identified by id using XML as the input format.
     *
     * @param id identifier for the entity
     * @param data an SettingsfltFriendsConverter entity that is deserialized from a XML stream
     */
    @PUT
    @Consumes({"application/xml", "application/json"})
    public void put(SettingsfltFriendsConverter data) {
        PersistenceService persistenceSvc = PersistenceService.getInstance();
        try {
            persistenceSvc.beginTx();
            EntityManager em = persistenceSvc.getEntityManager();
            SettingsfltFriends entity = em.find(SettingsfltFriends.class, id);
            entity.setActivefltFriends(data.getEntity().getActivefltFriends());
            entity.setFrecfltFriends(data.getEntity().getFrecfltFriends());
    ...
    /**
     * Delete method for deleting an instance of SettingsfltFriends identified by id.
     *
     * @param id identifier for the entity
     */
    @DELETE
    ...
    /**
     * Returns an instance of SettingsfltFriends identified by id.
     *
     * @param id identifier for the entity
     * @return an instance of SettingsfltFriends
     */
    protected SettingsfltFriends getEntity() {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
        try {
            return (SettingsfltFriends) em.createQuery("SELECT e FROM SettingsfltFriends e where e.userSettingsUid = :userSettingsUid").setParameter("userSettingsUid", id).getSingleResult();
     ...
     */
    private SettingsfltFriends updateEntity(SettingsfltFriends entity, SettingsfltFriends newEntity) {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
        ...
        for (SettingsAngels value : settingsAngelsCollection) {
            if (!settingsAngelsCollectionNew.contains(value)) {
                value.getSettingsfltFriendsCollection().remove(entity);
            }
        }
        ...
        if (userSettings != null && !userSettings.equals(userSettingsNew)) {
            userSettings.setSettingsfltFriends(null);
        }
        if (userSettingsNew != null && !userSettingsNew.equals(userSettings)) {
            userSettingsNew.setSettingsfltFriends(entity);
        }
        return entity;
    }
     ...
     */
    private void deleteEntity(SettingsfltFriends entity) {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
    ...
    public static class SettingsAngelsCollectionResourceSub extends SettingsAngelssResource {
        ...
        private SettingsfltFriends parent;

        public void setParent(SettingsfltFriends parent) {
            this.parent = parent;
        }
