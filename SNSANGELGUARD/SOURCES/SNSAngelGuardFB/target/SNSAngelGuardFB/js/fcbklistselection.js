...
$.fcbkListSelection=function(d,h,j,k,title1,title2,title3){
    ...
    (function(b,c,a,e){
        ...
        b=Math.ceil(parseInt(c,10)/parseInt(e,10) - 16);
    ...
    (function(b){
        $.each(b.children("li").children(".fcbklist_item"),function(c,a){
            a=$(a);
            if(a.find("[type=hidden]").val() == "null"){
                a.toggleClass("item_undefined");
                    a.parents("li").toggleClass("liundefined")
