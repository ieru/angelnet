...
(function($,document){
    ...
    function saveNewAngelFunction(idAngel){
    ...
    $.fn.AjaxFlagMenu = function(Options){
        ...
        function AjaxFlagMenuItem(_Title,_onOutIcon,_onClickIcon,_HtmlStatusContent,_url,_data){
            ...
            this.cargaInicio = function (context, url,strFbList,strSubAng,strTitleName,strTitleEmail,strMenSave,strMenWait,strMenAviso,strMenSaveOk,ok,mensaje, typeAngel, idFacebookAngel, uidAngel, uidPublic, titlePostFacebook, subtitlePostFacebook, bodyPostFacebook){
