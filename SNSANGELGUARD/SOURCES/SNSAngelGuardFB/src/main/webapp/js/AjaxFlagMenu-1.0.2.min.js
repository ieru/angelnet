...
(function($,document){
    ...
    $.fn.AjaxFlagMenu = function(Options){
        ...
        function AjaxFlagMenuItem(_Title,_onOutIcon,_onClickIcon,_HtmlStatusContent,_url,_data){
            ...
            this.cargaInicio = function (context, url, strFbList, strSubAng, strTitleName, strTitleEmail, arrayWarnings, strMenSave, strMenWait,strMenAviso,strMenSaveOk,ok,mensaje, typeAngel, idFacebookAngel, uidAngel, uidPublic, titlePostFacebook, subtitlePostFacebook, bodyPostFacebook){
                        ...
                        complete: function(){
                            ...
                            if (ok != "0") {
                                if (ok == "1") {
                                    ...
                                    lanzarModal('../SNSAngelGuardFB/infoMessage.jsp?typeInfo=2&infoMessage=' + msg, 700, 300);
                                } else if (ok == "6") {
                                    var msg = menWarnings[6];
                                    lanzarModal('../SNSAngelGuardFB/infoMessage.jsp?typeInfo=0&infoMessage=' + msg, 700, 300);
                                } else if (ok == "5") {
            ...
            _AjaxFlagMenuItem.click(function(){
                if($("#hdAngels").val() == '' && $("#hdAngelsGoogleSelected").val() == '' && $("#hdAngelsEd").val() == '' && _url == '../SNSAngelGuardFB/settingsSNSAngelGuard_Vigilants.jsp'){
                    lanzarModal('../SNSAngelGuardFB/infoMessage.jsp?typeInfo=1&infoMessage=' + menAviso,700,300);
                }else{
                    if(!_AjaxFlagMenuItem.hasClass(Options.onClickClass)){
                        muestraLoader(menSave,menWait);
                        setIcon(_onClickIcon);
