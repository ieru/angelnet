    ...
    public void loadLocaleSettingsOffLine() {
        ...
        try {
            ...
            this.localeSettingsDao = new LocaleSettingsDAO(jsonLocale.getString("idLocale"), jsonLocale.getString("acceptingTerms"),
                    ...
                    new JSONObject(jsonLocale.getString("titleVigSettVig")), new JSONObject(jsonLocale.getString("titleVigDescriptionSettVig")), jsonLocale.getString("titleVigFrecSettVig"),
                    ...
                    jsonLocale.getString("titleActiveDesactiveVig"), jsonLocale.getString("titleTutInitHelp"), jsonLocale.getString("desTutInitHelp"), jsonLocale.getString("titlePagTutInitHelp"));
